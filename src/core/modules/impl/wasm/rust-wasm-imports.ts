...
export const rustWasmImports = (swGlobal, wbindgenImports, wasmInstance, dtorValue): any => {
  ...
  let module: any = wbindgenImports.reduce((acc, wbindgenKey) => {
    ...
    return acc;
  }, { res: {}, usedKeys: new Set<String>() }).res;
