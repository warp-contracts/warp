...
export const rustWasmImportsMsgpack = (swGlobal, wbindgenImports, wasmInstance, dtorValue): any => {
  ...
  const rawImports = {
    ...
    console: {
      log: function (value) {
        wasmLogger.error(`${swGlobal.contract.id}: ${value}`);
      }
    },
    Block: {
      height: function () {
  ...
  const baseImports = {
    ...
    //         }
    //       };
    //       var ret = new Promise(cb0) as any;
    //       return addHeapObject(ret);
    //     } finally {
    //       state0.a = state0.b = 0;
    //     }
    //   } else {
    //     var ret = new Uint8Array(getObject(arg0)) as any;
    //     return addHeapObject(ret);
    //   }
    // },
    ...
    __wbg_newwithbyteoffsetandlength: function (arg0, arg1, arg2) {
    ...
    __wbindgen_memory: function () {
      var ret = wasmInstance.exports.memory;
      return addHeapObject(ret);
    },
    __wbindgen_closure_wrapper: function (arg0, arg1, arg2) {
      var ret = makeMutClosure(arg0, arg1, dtorValue, __wbg_adapter_10);
      return addHeapObject(ret);
    },
    __wbg_set: function (arg0, arg1, arg2) {
      getObject(arg0).set(getObject(arg1), arg2 >>> 0);
    },
    __wbg_length: function (arg0) {
  ...
  module.initState = function (state) {
    wasmInstance.exports.initState(addHeapObject(state));
  };
  ...
  module.currentState = function () {
    try {
      ...
      wasmInstance.exports.currentState(retptr);
